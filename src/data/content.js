export const siteContent = {
  hero: {
    headline: "VELTRIX",
    subheadline: "Digital excellence for the next generation of industry leaders.",
  ...
  manifesto: {
    ...
    paragraph: "We don't just build websites; we build partnerships. Our goal is to empower your business with tools that are not only cutting-edge but also easy to use, secure, and ready for the future."
  },
  innovation: {
    title: "The Edge",
